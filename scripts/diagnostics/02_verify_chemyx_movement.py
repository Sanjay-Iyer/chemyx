...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--port", help="serial port, e.g. REPLACE_WITH_COM_PORT")
...
def main() -> int:
    ...
    cfg = config.load_pump_config(
        load_local=False,
        port=args.port if args.port is not None else machine.chemyx.serial_port,
        baud_rate=args.baud if args.baud is not None else machine.chemyx.baud_rate,
